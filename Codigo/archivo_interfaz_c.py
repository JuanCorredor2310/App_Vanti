...
def crear_label(texto, central_widget, font="normal", color="white", font_size=30, background_color="#030918", line_edit=False):
    font_size = round(font_size*val_res)
    if line_edit:
...
def crear_pantalla_incial():
    ...
    pixmap = pixmap.scaled(round(320*val_res),round(80*val_res), aspectRatioMode=1)
    icon = QIcon(pixmap)
    image_button.setIcon(icon)
    image_button.setIconSize(pixmap.size())
    x = int(screen_width-image_button.sizeHint().width())-20
    y = int(screen_height-image_button.sizeHint().height())-20
    image_button.move(x,y)
...
def pantalla_inicio(app, window, central_widget, dimensiones):
    ...
    pixmap = pixmap.scaled(round(155*val_res),round(155*val_res), aspectRatioMode=1)
    icon = QIcon(pixmap)
    image_button.setIcon(icon)
    image_button.setIconSize(pixmap.size())
    image_button.move(round(1550*val_res),round(180*val_res))
    mostrar_label(image_button)
...
def menu_inicial(app, window, central_widget, dimensiones, estado=None, info=None):
    ...
    icon = QIcon(pixmap)
    image_button.setIcon(icon)
    image_button.setIconSize(QSize(round(100*val_res), round(100*val_res)))
    image_button.move(round(20*val_res),round(20*val_res))
    mostrar_label(image_button)
    ...
    image_button_1.setIconSize(QSize(round(80*val_res), round(80*val_res)))
    image_button_1.setFixedSize(round(150*val_res), round(150*val_res))
    ...
    pixmap = QPixmap(ruta_imagenes+"vanti_logo.png")
    pixmap = pixmap.scaled(round(140*val_res),round(140*val_res), aspectRatioMode=1)
    icon = QIcon(pixmap)
    image_button_2.setIcon(icon)
    image_button_2.setIconSize(pixmap.size())
    image_button_2.move(round(1400*val_res),round(115*val_res))
...
def menu_edicion_archivos(app, window, central_widget, dimensiones, estado=None, info={}):
    ...
    titulo_espacios = crear_label(titulo, central_widget, font="bold", font_size=75)
    x = round((screen_width-titulo_espacios.sizeHint().width())*0.5)
    titulo_espacios.move(round(x*val_res), round(40*val_res))
    mostrar_label(titulo_espacios)
    image_button = QPushButton("", central_widget)
    pixmap = QPixmap(ruta_imagenes+"flecha.png")
    icon = QIcon(pixmap)
    ...
    for boton in botones:
        boton.setFixedWidth(max_width)
    x = round(((screen_width*0.5)-max_width)*0.5)
    boton_1.move(round(x*val_res),round(400*val_res))
    boton_1.setParent(central_widget)
    mostrar_label(boton_1)
    boton_3.move(round(x*val_res),round(600*val_res))
    boton_3.setParent(central_widget)
    mostrar_label(boton_3)
    boton_5.move(round(x*val_res),round(800*val_res))
    boton_5.setParent(central_widget)
    mostrar_label(boton_5)
    x = round((((screen_width*0.5)-max_width)*0.5)+(screen_width*0.5))
    boton_2.move(round(x*val_res),round(400*val_res))
    boton_2.setParent(central_widget)
    mostrar_label(boton_2)
    boton_4.move(round(x*val_res),round(600*val_res))
    boton_4.setParent(central_widget)
    mostrar_label(boton_4)
    boton_6.move(round(x*val_res),round(800*val_res))
    boton_6.setParent(central_widget)
    mostrar_label(boton_6)
...
def menu_reportes_comerciales(app, window, central_widget, dimensiones, estado=None, info={}):
    ...
    mostrar_label(boton_6)
    x = round((((screen_width)-max_width)*0.5))
    boton_7.move(round(x*val_res),round(1000*val_res))
    boton_7.setParent(central_widget)
    mostrar_label(boton_7)
...
def menu_reporte_comercial(app, window, central_widget, dimensiones, estado=None, info={}):
    ...
    for boton in botones:
        boton.setFixedWidth(max_width)
    x = round(((screen_width*0.5)-max_width)*0.5)
    boton_1.move(round(x*val_res),round(700*val_res))
    boton_1.setParent(central_widget)
    mostrar_label(boton_1)
    x = round((((screen_width*0.5)-max_width)*0.5)+(screen_width*0.5))
    boton_2.move(round(x*val_res),round(700*val_res))
    boton_2.setParent(central_widget)
    mostrar_label(boton_2)
...
def menu_reportes_tecnicos(app, window, central_widget, dimensiones, estado=None, info={}):
    ...
    boton_1.setParent(central_widget)
    mostrar_label(boton_1)
    boton_2.move(round(x*val_res),round(600*val_res))
    boton_2.setParent(central_widget)
    mostrar_label(boton_2)
    boton_3.move(round(x*val_res),round(800*val_res))
    boton_3.setParent(central_widget)
    mostrar_label(boton_3)
...
def menu_KPIs(app, window, central_widget, dimensiones, estado=None, info={}):
    ...
    for boton in botones:
        boton.setFixedWidth(max_width)
    x = round((((screen_width)-max_width)*0.5))
    boton_1.move(round(x*val_res),round(350*val_res))
    boton_1.setParent(central_widget)
    mostrar_label(boton_1)
    boton_2.move(round(x*val_res),round(500*val_res))
    boton_2.setParent(central_widget)
    mostrar_label(boton_2)
    boton_3.move(round(x*val_res),round(650*val_res))
    boton_3.setParent(central_widget)
    mostrar_label(boton_3)
    boton_4.move(round(x*val_res),round(800*val_res))
    boton_4.setParent(central_widget)
    mostrar_label(boton_4)
    boton_5.move(round(x*val_res),round(950*val_res))
    boton_5.setParent(central_widget)
    mostrar_label(boton_5)
...
def menu_CLD_PRD(app, window, central_widget, dimensiones, estado=None, info={}, estado_anterior=None):
    ...
    titulo_espacios_1.move(round(x*val_res), round(180*val_res))
    ...
    for boton in botones:
        boton.setFixedWidth(max_width)
    x = round((((screen_width)-max_width)*0.5))
    boton_1.move(round(x*val_res),round(450*val_res))
    boton_1.setParent(central_widget)
    mostrar_label(boton_1)
    boton_2.move(round(x*val_res),round(600*val_res))
    boton_2.setParent(central_widget)
    mostrar_label(boton_2)
    boton_3.move(round(x*val_res),round(750*val_res))
    boton_3.setParent(central_widget)
    mostrar_label(boton_3)
    boton_4.move(round(x*val_res),round(900*val_res))
    boton_4.setParent(central_widget)
    mostrar_label(boton_4)
...
def menu_comercial_calidad_info(app, window, central_widget, dimensiones, estado=None, info={}, estado_anterior=None):
    ...
    for boton in botones:
        boton.setFixedWidth(max_width)
    x = round(((screen_width*0.5)-max_width)*0.5)
    boton_1.move(round(x*val_res),round(550*val_res))
    boton_1.setParent(central_widget)
    mostrar_label(boton_1)
    boton_2.move(round(x*val_res),round(850*val_res))
    boton_2.setParent(central_widget)
    mostrar_label(boton_2)
    x = round((((screen_width*0.5)-max_width)*0.5)+(screen_width*0.5))
    boton_3.move(round(x*val_res),round(550*val_res))
    boton_3.setParent(central_widget)
    mostrar_label(boton_3)
    boton_4.move(round(x*val_res),round(850*val_res))
    boton_4.setParent(central_widget)
    mostrar_label(boton_4)
    event_loop = QEventLoop()
    def on_button_clicked(texto):
...
def menu_seleccion(app, window, central_widget, dimensiones, estado_anterior=None, estado=None, info={}, incluir_anual=True, c_meses=13):
    ...
    x = round((screen_width-titulo_espacios.sizeHint().width())*0.5)
    titulo_espacios.move(round(x*val_res), round(10*val_res))
    titulo_espacios.setParent(central_widget)
    mostrar_label(titulo_espacios)
    t_filial = crear_label("Filiales", central_widget, font="bold", font_size=50)
    t_filial.move(round(50*val_res), round(150*val_res))
    ...
    boton_1.move(round(x*val_res),round(1100*val_res))
    boton_1.setParent(central_widget)
    mostrar_label(boton_1)
    ...
    boton_3.move(round(x*val_res),round(150*val_res))
    boton_3.setParent(central_widget)
    mostrar_label(boton_3)
    ...
    lista_fechas_sel = []
    dic_fechas = {}
    x_fecha = round(620*val_res)
    for anio in lista_anios_sel:
        y_fecha = round(300*val_res)
        for mes in lista_meses:
            ...
            dic_fechas[llave][2].setFixedSize(round(48*val_res),round(48*val_res))
            dic_fechas[llave][2].setParent(central_widget)
            dic_fechas[llave][3].setParent(central_widget)
            dic_fechas[llave][2].move(round(x_fecha*val_res),round(y_fecha*val_res))
            dic_fechas[llave][3].move(round((x_fecha+100)*val_res), round((y_fecha-10)*val_res))
            y_fecha += round(65*val_res)
            mostrar_label(dic_fechas[llave][2])
            mostrar_label(dic_fechas[llave][3])
        x_fecha += round(450*val_res)
    image_button = QPushButton("", central_widget)
    pixmap = QPixmap(ruta_imagenes+"flecha.png")
    icon = QIcon(pixmap)
    image_button.setIcon(icon)
...
def menu_seleccion_trimestres(app, window, central_widget, dimensiones, estado_anterior=None, estado=None, info={}):
    ...
    t_periodo.move(round(x*val_res), round(150*val_res))
    t_periodo.setParent(central_widget)
    mostrar_label(t_periodo)
    anual = True
    boton_1 = crear_boton("Aceptar", central_widget, font_size=25)
    ...
    boton_3 = crear_boton("Limpiar", central_widget, font_size=25)
    x = round((((screen_width*0.5)-boton_3.sizeHint().width())*0.5)+(screen_width*0.53))
    boton_3.move(round(1700*val_res),round(150*val_res))
    boton_3.setParent(central_widget)
    mostrar_label(boton_3)
    if len(lista_anios) >= 3 :
        lista_anios_sel = lista_anios[-3:]
    ...
    for anio in lista_anios_sel:
        ...
        for trim in lista_trimestres:
            ...
            dic_fechas[llave][2].setFixedSize(round(110*val_res),round(110*val_res))
            dic_fechas[llave][2].setParent(central_widget)
            dic_fechas[llave][3].setParent(central_widget)
            dic_fechas[llave][2].move(round(x_fecha*val_res),round(y_fecha*val_res))
            dic_fechas[llave][3].move(round((x_fecha + 95)*val_res), round((y_fecha-10)*val_res))
            y_fecha += round(180*val_res)
            mostrar_label(dic_fechas[llave][2])
            mostrar_label(dic_fechas[llave][3])
        x_fecha += round(620*val_res)
    image_button = QPushButton("", central_widget)
...
def menu_dashboard(app, window, central_widget, dimensiones, estado_anterior=None, estado=None, info={}):
    ...
    mostrar_label(boton_1)
    boton_3 = crear_boton("Limpiar", central_widget, font_size=25)
    boton_3.move(round(1700*val_res),round(280*val_res))
    boton_3.setParent(central_widget)
    boton_4 = crear_boton("Actual", central_widget, font_size=25)
    boton_4.move(round(1700*val_res),round(180*val_res))
    boton_4.setParent(central_widget)
    botones = [boton_3, boton_4]
    max_width = max([boton.sizeHint().width() for boton in botones])
    for boton in botones:
        boton.setFixedWidth(round((max_width+15)*val_res))
    mostrar_label(boton_3)
    mostrar_label(boton_4)
    ...
    for anio in lista_anios_sel:
        ...
        for mes in lista_meses:
            ...
            dic_fechas[llave][3].setParent(central_widget)
            dic_fechas[llave][2].move(round(x_fecha*val_res),round(y_fecha*val_res))
            dic_fechas[llave][3].move(round((x_fecha + 85)*val_res), round((y_fecha-10)*val_res))
            y_fecha += round(65*val_res)
            mostrar_label(dic_fechas[llave][2])
            mostrar_label(dic_fechas[llave][3])
        x_fecha += round(425*val_res)
    image_button = QPushButton("", central_widget)
    pixmap = QPixmap(ruta_imagenes+"flecha.png")
    icon = QIcon(pixmap)
    image_button.setIcon(icon)
...
def opciones_adicionales_dashboard(app, window, central_widget, dimensiones, estado=None, info={}, fecha_personalizada=None):
    ...
    x = round((screen_width-titulo_espacios_1.sizeHint().width())*0.5)
    titulo_espacios_1.move(round(x*val_res), round(150*val_res))
    titulo_espacios_1.setParent(central_widget)
    mostrar_label(titulo_espacios_1)

    label_codigo_DANE = crear_label("", central_widget, font="bold", font_size=12)
    label_codigo_DANE.move(round(50*val_res), round(980*val_res))
    ...
    pixmap_check = pixmap_check.scaled(round(320*val_res),round(80*val_res), aspectRatioMode=1)
    icon_check = QIcon(pixmap_check)
    label_check.setIcon(icon_check)
    label_check.setIconSize(pixmap_check.size())
    label_check.move(round(1660*val_res),round(980*val_res))
    esconder_label(label_check)
    lista_x_pos = [round(200*val_res), round(780*val_res), round(1400*val_res)]
    c_x = 0
    c_y = round(500*val_res)
    c_c = 0
    cambio = round(300*val_res)
    ...
    for llave, valor in opciones.items():
        ...
        boton_for.setFixedSize(round(110*val_res),round(110*val_res))
        boton_for.setParent(central_widget)
        label_for.setParent(central_widget)
        boton_for.move(lista_x_pos[c_x], c_y)
        label_for.move(lista_x_pos[c_x]+round(150*val_res), c_y)
    ...
    image_button_1.setFixedSize(round(150*val_res), round(150*val_res))
    x = round((screen_width-(image_button_1.sizeHint().width()))*0.95)
    image_button_1.move(round(x*val_res),round(5*val_res))
    image_button_2 = QPushButton("", central_widget)
    pixmap_2 = QPixmap(ruta_imagenes+"lupa.png")
    icon_2 = QIcon(pixmap_2)
    image_button_2.setIcon(icon_2)
    image_button_2.setIconSize(QSize(round(45*val_res), round(45*val_res)))
    image_button_2.setFixedSize(round(45*val_res), round(45*val_res))
    image_button_2.move(round(740*val_res),round(1000*val_res))
    mostrar_label(image_button_1)
...
def seleccionar_reporte(app, window, central_widget, dimensiones, estado=None, info={}, estado_anterior=""):
    ...
    t_comercial.move(round(50*val_res), round(150*val_res))
    ...
    t_tarifario.move(round(780*val_res), round(150*val_res))
    ...
    t_tecnico.move(round(1400*val_res), round(150*val_res))
    t_tecnico.setParent(central_widget)
    mostrar_label(t_tecnico)
    dic_reportes = {}
    lista_x_reportes = [round(50*val_res), round(780*val_res), round(1400*val_res)]
    for i, (llave, valor) in enumerate(reportes_disponibles.items()):
        y_reporte = round(300*val_res)
        for elemento in valor:
            if elemento != "GRTT2SAP":
                ...
                boton_for.setFixedSize(round(56*val_res),round(56*val_res))
                boton_for.setParent(central_widget)
                label_for.setParent(central_widget)
                boton_for.move(lista_x_reportes[i] + round(80*val_res),y_reporte)
                label_for.move(lista_x_reportes[i] + round(180*val_res), y_reporte - round(15*val_res))
                dic_reportes[llave][elemento] = [False, boton_for, label_for]
                mostrar_label(label_for)
                mostrar_label(boton_for)
                y_reporte += round(80*val_res)
    boton_1 = crear_boton("Aceptar", central_widget, font_size=25)
    x = round((((screen_width*0.5)-boton_1.sizeHint().width())*0.5)+(screen_width*0.53))
    boton_1.move(round(x*val_res),round(1100*val_res))
    boton_1.setParent(central_widget)
...
def seleccionar_periodo(app, window, central_widget, dimensiones, estado=None, info={}, estado_anterior="", incluir_anual=True, c_meses=12):
    ...
    for anio in lista_anios_sel:
        ...
        for mes in lista_meses:
            ...
            dic_fechas[llave][3].setParent(central_widget)
            dic_fechas[llave][2].move(round(x_fecha*val_res), round(y_fecha*val_res))
            dic_fechas[llave][3].move(x_fecha + round(85*val_res), y_fecha-round(10*val_res))
            y_fecha += round(65*val_res)
            mostrar_label(dic_fechas[llave][2])
            mostrar_label(dic_fechas[llave][3])
        x_fecha += round(425*val_res)
...
def seleccionar_categoria(app, window, central_widget, dimensiones, estado=None, info={}, estado_anterior=""):
    ...
    dic_categorias = {}
    lista_y = [round(300*val_res),round(450*val_res),round(600*val_res)]
    for i in range(len(lista_categorias)):
        ...
        boton_for.setParent(central_widget)
        label_for.setParent(central_widget)
        boton_for.move(round(700*val_res),round(y_reporte*val_res))
        label_for.move(round(800*val_res),round(y_reporte*val_res)-round(20*val_res))
        mostrar_label(boton_for)
        mostrar_label(label_for)
    ...
    label_nuevo_reporte.move(round(50*val_res), round(980*val_res))
    ...
    v_line_edit.move(round(700*val_res),round(1000*val_res))
    ...
    label_check.setIcon(icon_check)
    label_check.setIconSize(pixmap_check.size())
    label_check.move(1280,round(980*val_res))
    esconder_label(label_check)
...
def seleccionar_carpetas(app, window, central_widget, dimensiones, estado=None, info={}, estado_anterior=""):
    ...
    mostrar_label(titulo_espacios)
    dic_carpetas = {}
    lista_x_reportes = [round(50*val_res), round(900*val_res)]
    c_x = 0
    c_y = round(300*val_res)
    c_c = 0
    for valor in lista_carpetas_extra:
        ...
        boton_for.setFixedSize(round(80*val_res),round(80*val_res))
        boton_for.setParent(central_widget)
        label_for.setParent(central_widget)
        boton_for.move(lista_x_reportes[c_x] + round(80*val_res), c_y)
        label_for.move(lista_x_reportes[c_x] + round(180*val_res), c_y - round(25*val_res))
        dic_carpetas[valor] = [False, boton_for, label_for]
        mostrar_label(label_for)
        mostrar_label(boton_for)
        c_c += 1
        c_y += round(120*val_res)
        if c_c > 5:
            c_x += 1
            c_c = 0
            c_y = round(300*val_res)
...
def confirmacion_seleccion(app, window, central_widget, dimensiones, texto, op, estado_anterior):
    ...
    x =  round((screen_width-boton_1.sizeHint().width())*0.5)
    boton_1.move(x,700)
    boton_1.setParent(central_widget)
    mostrar_label(boton_1)
...
def opciones_adicionales(app, window, central_widget, dimensiones, opciones={}, estado=None, info=None, estado_anterior=None):
    ...
    label_cantidad_filas.move(round(50*val_res), round(980*val_res))
    label_cantidad_filas.setParent(central_widget)
    esconder_label(label_cantidad_filas)
    cambio = round(120*val_res)
    codigo_DANE = False
    if "codigo_DANE" in opciones:
        if opciones["codigo_DANE"]:
            ...
            v_line_edit.move(round(x*val_res),round(1000*val_res))
            v_line_edit.setParent(central_widget)
            mostrar_label(v_line_edit)
            cambio = round(150*val_res)
            codigo_DANE = True
    ...
    label_check.move(round(1660*val_res),round(980*val_res))
    esconder_label(label_check)
    lista_x_pos = [round(50*val_res), round(780*val_res), round(1400*val_res)]
    c_x = 0
    c_y = round(200*val_res)
    c_c = 0
    dic_opciones_botones = {}
    dic_texto = {}
    for llave, valor in opciones.items():
        ...
        if llave != "codigo_DANE" and llave != "cantidad_filas":
            ...
            boton_for.setParent(central_widget)
            label_for.setParent(central_widget)
            boton_for.move(lista_x_pos[c_x] + round(80*val_res), c_y)
            label_for.move(lista_x_pos[c_x] + round(150*val_res), c_y - round(25*val_res))
            dic_opciones_botones[llave] = [False, boton_for, label_for]
            mostrar_label(label_for)
            mostrar_label(boton_for)
            c_c += 1
...
def ventana_secundaria(central_widget, titulo, dic_texto, lista=True):
    ...
    x = central_widget.geometry().left()
    y = central_widget.geometry().top()
    width = int(central_widget.width()*0.9)
    height = int(central_widget.height()*0.9)
    ventana.setGeometry (round(x*val_res), round(y*val_res), round(width*val_res), round(height*val_res))
    ventana.setStyleSheet(f"""QWidget{{background-color: #030918; border: 5px solid #030918}}""")
    layout = QVBoxLayout()
    font_size = round(24*val_res)
    font_id = QFontDatabase().addApplicationFont(ruta_fuente)
    font_family = QFontDatabase().applicationFontFamilies(font_id)[0]
